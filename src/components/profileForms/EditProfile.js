...
const EditProfile = ({ navigation }) => {
  const { state, createProfile, getCurrentProfile } =
  ...
  const [nameAddress, setNameAddress] = useState({
    completeaddress: "",
    city:
      state.profile.loading || !state.profile.city ? "" : state.profile.city,
    area:
      state.profile.loading || !state.profile.area ? "" : state.profile.area,
    state:
      state.profile.loading || !state.profile.state ? "" : state.profile.state,
    lat: state.profile.loading || !state.profile.lat ? "" : state.profile.lat,
    lng: state.profile.loading || !state.profile.lng ? "" : state.profile.lng,
  });

  const [gender, setGender] = useState(
    state.profile.loading || !state.profile.gender ? "" : state.profile.gender
  );
  const [civilstatus, setCivilStatus] = useState(
    state.profile.loading || !state.profile.civilstatus
      ? ""
      : state.profile.civilstatus
  );
  const [birthday, setBirthday] = useState(
    state.profile.loading || !state.profile.birthday
      ? ""
      : state.profile.birthday
  );
  const [contactperson, setContactPerson] = useState(
    state.profile.loading || !state.profile.emergencyinfo
      ? ""
      : state.profile.emergencyinfo.contactperson
  );
  const [contactnumber, setContactNumber] = useState(
    state.profile.loading || !state.profile.emergencyinfo
      ? ""
      : state.profile.emergencyinfo.contactnumber
  );
  const [bloodtype, setBloodType] = useState(
    state.profile.loading || !state.profile.emergencyinfo
      ? ""
      : state.profile.emergencyinfo.bloodtype
  );
  ...
  const profilePayload =
    filePath === "" ? state.profile.profilepic : stateProfile;
            ...
            ListHeaderComponent={
              <View style={{ alignItems: "center" }}>
                <View style={styles.componentsContainer}>
                  ...
                  {/* Photo Profile */}
                  <ProfileImage state={state} setFilePath={setFilePath} />
                  <TextInput
