      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={{ paddingHorizontal: 10 }}>
          ...
          <Text style={styles.txtMain}>
            Guardian Command and Control (“we,” “our,” or “us”) is committed to
            protecting your privacy. This Privacy Policy explains how your
            personal information is collected, used, and disclosed by Guardian
            Command and Control. This Privacy Policy applies to our website, and
            its associated subdomains (collectively, our “Service”) alongside
            our application, Guardian Command and Control. By accessing or using
          ...
          <Text style={styles.txtMain}>
            ...
            defined as: Cookie: small amount of data generated by a website and
            ...
            language preference or login information. Company: when this policy
            mentions “Company,” “we,” “us,” or “our,” it refers to SugboTek
            Inc., Room 210 KRC Bldg. Subangdaku, Mandaue City that is
            responsible for your information under this Privacy Policy. Country:
            where Guardian Command and Control or the owners/founders of
            Guardian Command and Control are based, in this case is Philippines
            Customer: refers to the company, organization or person that signs
            up to use the Guardian Command and Control Service to manage the
            ...
            other device that can be used to visit Guardian Command and Control
            and use the services. IP address: Every device connected to the
            ...
            device is connecting to the Internet. Personnel: refers to those
            individuals who are employed by Guardian Command and Control or are
            ...
            provided by Guardian Command and Control as described in the
            ...
            products or services we think may interest you. Website: Guardian
            Command and Control's site, which can be accessed via this URL:
            https://guardian.ph You: a person or entity that is registered with
            Guardian Command and Control to use the Services.
          </Text>
          <Text style={styles.txtHeader}>What Information Do We Collect?</Text>
          <Text style={styles.txtMain}>
            ...
            a survey or fill out a form. Name / Username Phone Numbers Email
            Addresses Mailing Addresses Job Titles Age Password We also collect
            information from mobile devices for a better user experience,
            although these features are completely optional: Location (GPS):
            Location data helps to create an accurate representation of your
            interests, and this can be used to bring more targeted and relevant
            ads to potential customers. Phonebook (Contacts list): Your contacts
            list allows the website to be much more easy to use by the user,
            since accessing your contacts from the app makes you save tons of
            time. Camera (Pictures): Granting camera permission allows the user
            to upload any picture straight from the website, you can safely deny
            camera permissions for this website. Photo Gallery (Pictures):
            Granting photo gallery access allows the user to upload any picture
            from their photo gallery, you can safely deny photo gallery access
            for this website.
          </Text>
          ...
          <Text style={styles.txtMain}>
            ...
            website (we continually strive to improve our website offerings
            based on the information and feedback we receive from you) To
          ...
          <Text style={styles.txtHeader}>
            When does Guardian Command and Control use end user information from
            third parties?
          </Text>
          <Text style={styles.txtMain}>
            Guardian Command and Control will collect End User Data necessary to
            provide the Guardian Command and Control services to our customers.
          ...
          <Text style={styles.txtHeader}>
            When does Guardian Command and Control use customer information from
            third parties?
          </Text>
          <Text style={styles.txtMain}>
            ...
            interest in becoming a Guardian Command and Control customer, we
            receive information from a third party that provides automated fraud
            detection services to Guardian Command and Control. We also
          ...
          <Text style={styles.txtMain}>
            ...
            hosting and maintaining our servers and the website, database
          ...
          <Text style={styles.txtMain}>
            Guardian Command and Control will collect personal information that
          ...
          <Text style={styles.txtMain}>
            ...
            Guardian Command and Control to you and fulfill the purposes
            ...
            behalf. When we no longer need to use your information and there is
            no need for us to keep it to comply with our legal or regulatory
          ...
          <Text style={styles.txtMain}>
            ...
            information you transmit to Guardian Command and Control or
          ...
          <Text style={styles.txtMain}>
            Guardian Command and Control is incorporated in Philippines.
            ...
            located throughout the world, and may be viewed and hosted anywhere
            in the world, including countries that may not have laws of general
          ...
          <Text style={styles.txtHeader}>
            Is the information collected through the Guardian Command and
            Control Service secure?
          </Text>
          <Text style={styles.txtMain}>
          ...
          <Text style={styles.txtMain}>
            ...
            information Guardian Command and Control collects depend on your
            relationship with Guardian Command and Control. Personnel may update
            or correct their information as detailed in our internal company
            employment policies. Customers have the right to request the
          ...
          <Text style={styles.txtHeader}>Personnel</Text>
          <Text style={styles.txtMain}>
            If you are a Guardian Command and Control worker or applicant, we
            ...
            contact us in order to (1) update or correct your information, (2)
            change your preferences with respect to communications and other
          ...
          <Text style={styles.txtHeader}>Sale of Business</Text>
          <Text style={styles.txtMain}>
            ...
            all of the assets of Guardian Command and Control or any of its
            Corporate Affiliates (as defined herein), or that portion of
            Guardian Command and Control or any of its Corporate Affiliates to
          ...
          <Text style={styles.txtHeader}>Affiliates</Text>
          <Text style={styles.txtMain}>
            ...
            control with Guardian Command and Control, whether by ownership or
          ...
          <Text style={styles.txtHeader}>Governing Law</Text>
          <Text style={styles.txtMain}>
            This Privacy Policy is governed by the laws of Philippines without
            ...
            to make claims under Privacy Shield, or the Swiss-US framework. The
            laws of Philippines, excluding its conflicts of law rules, shall
            ...
            international laws. By using Guardian Command and Control or
          ...
          <Text style={styles.txtMain}>
            ...
            Guardian Command and Control. We are not responsible for the
            ...
            from the Services to another website, our Privacy Policy is no
          ...
          <Text style={styles.txtHeader}>Advertising</Text>
          <Text style={styles.txtMain}>
            This website may contain third party advertisements and links to
            third party sites. Guardian Command and Control does not make any
            ...
            parties. Advertising keeps Guardian Command and Control and many of
            the websites and services you use free of charge. We work hard to
            make sure that ads are safe, unobtrusive, and as relevant as
            possible. Third party advertisements and links to other sites where
            goods or services are advertised are not endorsements or
            recommendations by Guardian Command and Control of the third party
            sites, goods or services. Guardian Command and Control takes no
          ...
          <Text style={styles.txtHeader}>Cookies for Advertising</Text>
          <Text style={styles.txtMain}>
          ...
          <Text style={styles.txtMain}>
            Guardian Command and Control uses "Cookies" to identify the areas of
          ...
          <Text style={styles.txtHeader}>Remarketing Services</Text>
          <Text style={styles.txtMain}>
          ...
          <Text style={styles.txtHeader}>Kids' Privacy</Text>
          <Text style={styles.txtMain}>
          ...
          <Text style={styles.txtHeader}>Changes To Our Privacy Policy</Text>
          <Text style={styles.txtMain}>
          ...
          <Text style={styles.txtMain}>
            ...
            Command and Control shall not be responsible for any Third-Party
            Services, including their accuracy, completeness, timeliness,
            validity, copyright compliance, legality, decency, quality or any
            other aspect thereof. Guardian Command and Control does not assume
            and shall not have any liability or responsibility to you or any
            other person or entity for any Third-Party Services. Third-Party
          ...
          <Text style={styles.txtHeader}>Tracking Technologies</Text>
          <Text style={styles.txtMain}>
            ...
            live data synching with location, plan routes, or create a mashup
            just to name a few. Google Maps API may collect information from You
            and from Your Device for security purposes. Google Maps API collects
            information that is held in accordance with its Privacy Policy
            Cookies We use Cookies to enhance the performance and functionality
            of our $platform but are non-essential to their use. However,
            ...
            remember that you had logged in previously. Local Storage Local
            Storage sometimes known as DOM storage, provides web apps with
            ...
            request header. Sessions Guardian Command and Control uses
          ...
          <Text style={styles.txtHeader}>What is GDPR?</Text>
          <Text style={styles.txtMain}>
            ...
            control the EU residents have, over their personal data. The GDPR is
            relevant to any globally operating company and not just the EU-based
            businesses and EU residents. Our customers’ data is important
          ...
          <Text style={styles.txtHeader}>What is personal data?</Text>
          <Text style={styles.txtMain}>
            ...
            collected must be processed in a fair, legal, and transparent way
            and should only be used in a way that a person would reasonably
            expect. Personal data should only be collected to fulfil a specific
            ...
            purpose. People covered by the GDPR have the right to access their
          ...
          <Text style={styles.txtHeader}>Why is GDPR important?</Text>
          <Text style={styles.txtMain}>
            ...
            the right thing to do. At Guardian Command and Control we strongly
          ...
          <Text style={styles.txtMain}>
            ...
            rights requirements of GDPR. Guardian Command and Control processes
            or stores all personal data in fully vetted, DPA compliant vendors.
            ...
            we will not hold it longer than 60 days. We are aware that if you
            are working with EU customers, you need to be able to provide them
          ...
          <Text style={styles.txtHeader}>California Residents</Text>
          <Text style={styles.txtMain}>
            ...
            collected about you. Right to Equal Service. We will not
            discriminate against you if you exercise your privacy rights. Right
            to Delete. You may submit a verifiable request to close your account
            and we will delete Personal Information about you that we have
            collected. Request that a business that sells a consumer's personal
            data, not sell the consumer's personal data. If you make a request,
            we have one month to respond to you. If you would like to exercise
            any of these rights, please contact us. We do not sell the Personal
          ...
          <Text style={styles.txtMain}>
            ...
            share it, which we have explained above. CalOPPA users have the
            following rights: Right to Know and Access. You may submit a
            verifiable request for information regarding the: (1) categories of
            Personal Information we collect, use, or share; (2) purposes for
            which categories of Personal Information are collected or used by
            ...
            to Delete. You may submit a verifiable request to close your account
            and we will delete Personal Information about you that we have
            collected. Right to request that a business that sells a consumer's
            ...
            exercise any of these rights, please contact us. We do not sell the
            Personal Information of our users. For more information about these
